            ...
            success :  function(data)
            {
                ...
                if(data=="logged")
                {
                    ...
                    $("#error").fadeIn(1000, function(){
                        ...
                        $("#error").html('<div class="alert alert-danger"><span class="glyphicon glyphicon-info-sign"></span> &nbsp; Username and password combination not recognised, please try again!</div>');
                    ...
                    $("#error").fadeIn(1000, function () {
                        ...
                        $("#error").html('<div class="alert alert-danger"><span class="glyphicon glyphicon-info-sign"></span> &nbsp; Please verify your account using the link sent to your email!</div>');
                    ...
                    $("#error").fadeIn(1000, function(){
                        ...
                        $("#error").html('<div class="alert alert-danger"><span class="glyphicon glyphicon-info-sign"></span> &nbsp; Please verify your account!</div>');
                    ...
                    $("#error").fadeIn(1000, function(){
                        ...
                        $("#error").html('<div class="alert alert-danger"><span class="glyphicon glyphicon-info-sign"></span> &nbsp; Query error occurred, please try again later</div>');
